...
class WeatherStation {
  String _apiKey = 'a89fbf6173713a98d5d9bd35a14833ad';
  ...
  Future<Weather> currentWeather({double lat, double lon}) async {
    String url = await _generateUrl(tag: WEATHER, lat: lat, lon: lon);
  ...
  Future<String> _generateUrl({String tag, double lat, double lon}) async {
