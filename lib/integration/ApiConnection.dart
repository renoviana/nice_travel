...
//  List<Schedule> formatScheduleJson(String cityName, int sizeElements)  {
//    return handleValue(getScheduleByCityName(cityName, sizeElements).body);
//  }
  ...
  Future<Response> getScheduleByCityName(String cityName, int sizeElements) {
   ...
   return http.get(url);
//        .then((value) => schedules = formatScheduleJson(value.body))
